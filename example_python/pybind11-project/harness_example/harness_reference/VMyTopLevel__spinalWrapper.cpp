...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[2] = new CDataSignalAccess( top.io_X );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/xuelin/projects/spinal-project/SpinalTemplateSbt/./simWorkspace/MyTopLevel/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/xuelin/projects/spinal-project/SpinalTemplateSbt/./simWorkspace/MyTopLevel/") + name + ".dat").c_str());
      #endif
    }
